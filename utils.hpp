...
namespace Settings {
		...
		bool Rapidfire = true;
		bool RadarESP = true;
		bool NoShootDelay = true;
		bool NoMinigunCooldown = true;
		bool NameESP = true;
		bool MemoryAim = true;
		bool ItemESP = true;
		bool InstaRevive = true;
		bool InstaReload = true;
		bool HealthESP = true;
		bool GrenadeTP = true;
		bool DistanceESP = true;
		bool AimWhileJump = true;
...
Vector3 ProjectWorldToScreen(Vector3 WorldLocation, Vector3 camrot)
{
	...
	uint64_t chain2 = Driver::read<uint64_t>(pid, chain1 + 0x140);
